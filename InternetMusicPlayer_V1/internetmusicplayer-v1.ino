...
void setup() {
  ...
  Particle.variable("4_PlayerState", PlayerState); // Shows Current MP3 Player State.
  Particle.variable("5_Song", Song); // Shows Current Song.
  Particle.variable("6_Folder", Folder); // Shows Current Folder (Folder 0 is all folders).
