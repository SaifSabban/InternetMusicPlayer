...
void setup() {
  ...
  Particle.function("01_PlayFolderSong", PlayFolderSong); // Go To Specific Song & Sepcific Folder,.
  Particle.function("02_MusicState", MusicState); // Plays, Pause, or Stop Current Song.
  Particle.function("03_SkipSong", SkipSong); // Skips Current Song.
  Particle.function("04_Volume", Volume); // Sets Volume Level.
  Particle.function("05_Cycle", Cycle); // Sets Cycle State.
  Particle.function("06_SpeakerState", SpeakerState); // Enable/Disable Speaker.
  Particle.function("07_MP3PlayerState", MP3PlayerState); // Sleep, Wake, Reset Player.
//  Particle.function("08_PlaySong", PlaySong); // Go To Sepcific Song On Current Folder.
//  Particle.function("09_PlayFolder", PlayFolder); // Go To Sepcific Folder, & First Song on That Folder.
